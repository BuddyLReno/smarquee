(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Smarquee"] = factory();
	else
		root["Smarquee"] = factory();
})(window, function() {
...
var web_animations_next_lite_min = __webpack_require__(0);
...
// CONCATENATED MODULE: ./src/html-utilities.js
function createScrollTitle(contentToInsert, container) {
  var scrollContent = `<div data-smarquee-scroll-wrapper>${contentToInsert}<span data-smarquee-scroll-title>${contentToInsert}</span></div>`;
...
// CONCATENATED MODULE: ./src/math-utilities.js
function calculateAnimationValues(totalWidth, velocity, separatorMargin = 0) {
  var finalDistance = totalWidth / 2 + separatorMargin / 2 + 2; // 2px kerning

  var time = totalWidth / velocity;
  return {
    distance: totalWidth,
...
function generateHash() {
  ...
  return randomLetter + Math.random().toString(36).substring(2, 15);
}
// CONCATENATED MODULE: ./src/css-utilities.js
function buildStyle(id, margin) {
  var style = `
  .Smarquee--${id} {
    overflow: hidden;
    white-space: nowrap;
...
// CONCATENATED MODULE: ./src/smarquee.js
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return smarquee_Smarquee; });





class smarquee_Smarquee {
  constructor(options = {}) {
    ...
    this.styleBlock = appendStyleBlock(buildStyle(this.id, this.settings.scrollingTitleMargin), this.id);
  }
  ...
  createScrollTitle() {
    this.scrollWrapper = createScrollTitle(this.originalMarqueeContent, this.marqueeContainer);
  }

  calculateAnimationProperties() {
    this.animationCalulations = calculateAnimationValues(this.marqueeContainer.scrollWidth, this.settings.velocity, this.settings.scrollingTitleMargin);
  }

  createAnimation() {
    var keyframesScrolling = [{
      transform: 'translate3d(0px, 0, 0)'
    }, {
      transform: `translate3d(-${this.animationCalulations.animatedDistance}px, 0, 0)`
    }];
    var kfeScrolling = new KeyframeEffect(this.scrollWrapper, keyframesScrolling, {
